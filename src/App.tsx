...
import TeacherStudyPal from "./pages/teacher/TeacherStudyPal";
...
// Shared (Timetable / Library / Events / Behavior)
...
import BehaviorPage from "./pages/shared/BehaviorPage";
        ...
        <TooltipProvider>
          ...
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/teacher/ai-assistant" element={<ProtectedRoute allowedRoles={["teacher", "admin"]}><TeacherStudyPal /></ProtectedRoute>} />
              ...
              <Route path="/admin/timetable" element={<ProtectedRoute allowedRoles={["admin"]}><TimetablePage role="admin" /></ProtectedRoute>} />
              <Route path="/admin/library" element={<ProtectedRoute allowedRoles={["admin"]}><LibraryPage role="admin" /></ProtectedRoute>} />
              <Route path="/admin/events" element={<ProtectedRoute allowedRoles={["admin"]}><EventsPage role="admin" /></ProtectedRoute>} />
              <Route path="/admin/behavior" element={<ProtectedRoute allowedRoles={["admin"]}><BehaviorPage role="admin" /></ProtectedRoute>} />

              <Route path="/teacher/timetable" element={<ProtectedRoute allowedRoles={["teacher", "admin"]}><TimetablePage role="teacher" /></ProtectedRoute>} />
              <Route path="/teacher/library" element={<ProtectedRoute allowedRoles={["teacher", "admin"]}><LibraryPage role="teacher" /></ProtectedRoute>} />
              <Route path="/teacher/events" element={<ProtectedRoute allowedRoles={["teacher", "admin"]}><EventsPage role="teacher" /></ProtectedRoute>} />
              <Route path="/teacher/behavior" element={<ProtectedRoute allowedRoles={["teacher", "admin"]}><BehaviorPage role="teacher" /></ProtectedRoute>} />

              <Route path="/student/timetable" element={<ProtectedRoute allowedRoles={["student"]}><TimetablePage role="student" /></ProtectedRoute>} />
              <Route path="/student/library" element={<ProtectedRoute allowedRoles={["student"]}><LibraryPage role="student" /></ProtectedRoute>} />
              <Route path="/student/events" element={<ProtectedRoute allowedRoles={["student"]}><EventsPage role="student" /></ProtectedRoute>} />
              <Route path="/student/behavior" element={<ProtectedRoute allowedRoles={["student"]}><BehaviorPage role="student" /></ProtectedRoute>} />

              <Route path="/parent/timetable" element={<ProtectedRoute allowedRoles={["parent"]}><TimetablePage role="parent" /></ProtectedRoute>} />
              <Route path="/parent/library" element={<ProtectedRoute allowedRoles={["parent"]}><LibraryPage role="parent" /></ProtectedRoute>} />
              <Route path="/parent/events" element={<ProtectedRoute allowedRoles={["parent"]}><EventsPage role="parent" /></ProtectedRoute>} />
              <Route path="/parent/behavior" element={<ProtectedRoute allowedRoles={["parent"]}><BehaviorPage role="parent" /></ProtectedRoute>} />
